...
class SpaceShooter(arcade.Window):
    ...
    def setup(self):
        ...
        # Setup the player
        self.player = arcade.Sprite("SpaceGame/arcade-a-primer/images/jet.png", SCALING)
        ...
        self.background_music = arcade.load_sound(
            "SpaceGame/arcade-a-primer/sounds/Apoxode_-_Electric_1.wav"
        )

        # Load our other sounds
        # Sound sources: Jon Fincher
        self.collision_sound = arcade.load_sound("SpaceGame/arcade-a-primer/sounds/Collision.wav")
        self.move_up_sound = arcade.load_sound("SpaceGame/arcade-a-primer/sounds/Rising_putter.wav")
        self.move_down_sound = arcade.load_sound("SpaceGame/arcade-a-primer/sounds/Falling_putter.wav")
    ...
    def add_enemy(self, delta_time: float):
        ...
        enemy = FlyingSprite("SpaceGame/arcade-a-primer/images/missile.png", SCALING)
    ...
    def add_cloud(self, delta_time: float):
        ...
        cloud = FlyingSprite("SpaceGame/arcade-a-primer/images/cloud.png", SCALING)
